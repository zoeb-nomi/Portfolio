// Targeted screenshot regen for home + about (desktop + mobile) after the
// 2026-08-03 polish pass. Mirrors scripts/audit.mjs but scoped to 2 pages.
// Run: node scripts/audit-targeted.mjs
